export const JIRA_OAUTH_URL = 'https://auth.atlassian.com/authorize'
export const JIRA_OAUTH_AUDIENCE = 'api.atlassian.com'
export const SLACK_OUATH_URL = 'https://slack.com/oauth/v2/authorize'
export const GITHUB_OAUTH_URL = 'https://github.com/login/oauth/authorize'
export const JIRA_OAUTH_STATE = 'jira-decover-login';
